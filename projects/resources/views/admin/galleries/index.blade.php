                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              @if($client->status=="active")
                                <a href="{!! route($route.'.deactive', [$client->id]) !!}" class="btn btn-outline-danger btn-xs raw-margin-right-8"> Deactive</a>
                              @else

                                <a href="{!! route($route.'.active', [$client->id]) !!}" class="btn btn-outline-success btn-xs raw-margin-right-8"> Active</a>
                              @endif
                            </td>
                            <td>
