...
<body style=" width: 100%; height: 100%; margin: 0 auto; color: #000; background: #FFFFFF; font-family: Arial, sans-serif; font-size: 12px; font-family: Arial;">
    <div class="main-area" style=" width:700px; margin: auto;">
        ...
        <div class="pro-area" style="border: 1px solid #dddddd; border-radius: 12px; padding: 10px 15px; padding-bottom: 0px;">
            ...
            <p style=" font-size: 15px; color: #454545; line-height: 24px; font-weight: 400; margin: 0 0 15px 0; text-align: left">Rental Agreement - You have received a copy of Rental Agreement.</p>
            ...
            <table class="pro-sec" style="padding: 10px 0; padding-bottom: 20px; border-spacing: 0px; width:100%;">
                            ...
                            <?php if($data['rental_aggrement_signature']): ?>
                             <tr>
                    <td class="pro-img" style="width: 45%; text-align: right; padding-right: 10px;">
                            Rental Agreement Signature
                        <img src="<?php echo e(asset($data['rental_aggrement_signature'])); ?>" style="width: 100px; border-radius: 8px; height: 85px; object-fit: cover;">
                    </td>
                </tr>
                        <?php endif; ?>
                      
                        <?php if($data['rental_aggrement_images']): ?>
                         <tr>
                    <td class="pro-img" style="width: 45%; text-align: right; padding-right: 10px;">
                        Rental Agreement Image
                             <img src="<?php echo e(asset($data['rental_aggrement_images'])); ?>"  style="width: 100px; border-radius: 8px; height: 85px; object-fit: cover;">
                         </td>
                     </tr>
                                <?php endif; ?>
                        <?php if($data['rental_agreement_link']): ?>
                         <tr>
                    <td class="pro-img" style="width: 45%; text-align: right; padding-right: 10px;">
                               Rental Agreement Link : <a href="<?php echo e(asset($data['rental_agreement_link'])); ?>"  > Click Here</a>
                           </td>
                       </tr>
                                <?php endif; ?>
...
</html><?php /**PATH /home/rv66rental/htdocs/www.rv66rental.com/projects/resources/views/mail/rental-aggrement-admin.blade.php ENDPATH**/ ?>