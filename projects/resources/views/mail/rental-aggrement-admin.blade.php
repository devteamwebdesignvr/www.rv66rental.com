        ...
        <div class="pro-area" style="border: 1px solid #dddddd; border-radius: 12px; padding: 10px 15px; padding-bottom: 0px;">
            ...
            <table class="pro-sec" style="padding: 10px 0; padding-bottom: 20px; border-spacing: 0px; width:100%;">
                    ...
                    <td class="pro-img" style="width: 45%; text-align: right; padding-right: 10px;">
                        ...
                        <img src="{{asset($data['rental_aggrement_signature'])}}" style="width: 100px; border-radius: 8px; height: 85px; object-fit: cover;">
                    </td>
                </tr>
                        @endif
                    ...
                    <td class="pro-img" style="width: 45%; text-align: right; padding-right: 10px;">
                        Rental Agreement Image
                             <img src="{{asset($data['rental_aggrement_images'])}}"  style="width: 100px; border-radius: 8px; height: 85px; object-fit: cover;">
                         </td>
                     </tr>
                                @endif
                        @if($data['rental_agreement_link'])
                         <tr>
                    <td class="pro-img" style="width: 45%; text-align: right; padding-right: 10px;">
                               Rental Agreement Link : <a href="{{asset($data['rental_agreement_link'])}}"  > Click Here</a>
                           </td>
                       </tr>
                                @endif
