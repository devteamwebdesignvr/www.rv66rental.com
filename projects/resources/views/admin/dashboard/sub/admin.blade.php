  ...
  <div class="row">
	...
	<div class="col-md-12">
		<div class="form-group">
		    ...
		    {!! Form::select("input['payment-type']",["sandbox"=>"sandbox","live"=>"live"],ModelHelper::getDataFromSetting('payment-type'),["class"=>"form-control"]) !!}
  ...
  <div class="row">
	...
	<div class="col-md-12">
		<div class="form-group">
		    ...
		    {!! Form::select("input['which_payment_gateway']",["Instapay"=>"Instapay","authorize"=>"authorize","paypal"=>"paypal","stripe"=>"stripe","paypal_and_stripe"=>"Both, Paypal & Stripe"],ModelHelper::getDataFromSetting('which_payment_gateway'),["class"=>"form-control"]) !!}
 ...
 <div class="row ">
	...
	<div class="col-md-9">
		<div class="form-group">
			<input type="text" class="form-control" name="input['AUTHORIZED_MERCHANT_LOGIN_ID']" value="{{ ModelHelper::getDataFromSetting('AUTHORIZED_MERCHANT_LOGIN_ID') }}" placeholder="MERCHANT LOGIN ID">
		</div>
	</div>
	...
	<div class="col-md-9">
		<div class="form-group">
			<input type="text" class="form-control" name="input['AUTHORIZED_MERCHANT_TRANSACTION_KEY']" value="{{ ModelHelper::getDataFromSetting('AUTHORIZED_MERCHANT_TRANSACTION_KEY') }}" placeholder="MERCHANT TRANSACTION KEY">
		</div>
	</div>
</div>
 ...
 <div class="row ">
	...
	<div class="col-md-9">
		<div class="form-group">
			<input type="text" class="form-control" name="input['instapay_key']" value="{{ ModelHelper::getDataFromSetting('instapay_key') }}" placeholder="Instapay key">
		</div>
	</div>
	...
	<div class="col-md-9">
		<div class="form-group">
			<input type="text" class="form-control" name="input['instapay_pin']" value="{{ ModelHelper::getDataFromSetting('instapay_pin') }}" placeholder="Instapay Pin">
		</div>
	</div>
</div>
