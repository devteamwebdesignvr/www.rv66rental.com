...
<body style=" width: 100%; height: 100%; margin: 0 auto; color: #000; background: #FFFFFF; font-family: Arial, sans-serif; font-size: 12px; font-family: Arial;">
    <div class="main-area" style=" width:700px; margin: auto;">
        ...
        <div class="pro-area" style="border: 1px solid #dddddd; border-radius: 12px; padding: 10px 15px; padding-bottom: 0px;">
	        ...
	        <p style=" font-size: 15px; color: #454545; line-height: 24px; font-weight: 400; margin: 0 0 15px 0; text-align: left">Congratulations, Your booking is confirmed. Please find details below.</p>
	        ...
	        <div class="price" style=" padding: 20px 0; border-top: 1px solid #dddddd;">
			    <h2 style="font-size: 16px; font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif; margin: 0; margin-bottom: 15px;">Payment details</h2>
			    <table class="prices" style="border-spacing: 0px; width:100%;">
			        
								 <tr class="price-per-night">
									<td style="padding-bottom: 15px;"><strong>Amount :</strong></td>
									<td class="amt" style="text-align: right; padding-bottom: 15px;"><?php echo ModelHelper::getDataFromSetting('payment_currency'); ?><?php echo e($payment->amount); ?></td>
								</tr>
								 <tr class="price-per-night">
									<td style="padding-bottom: 15px;"><strong>Payment Mode :</strong></td>
									<td class="amt" style="text-align: right; padding-bottom: 15px;"><?php echo e($payment->type); ?></td>
								</tr>
								 <tr class="price-per-night">
									<td style="padding-bottom: 15px;"><strong>Tran ID :</strong></td>
									<td class="amt" style="text-align: right; padding-bottom: 15px;"><?php echo e($payment->tran_id); ?></td>
								</tr>
								<?php if($payment->balance_transaction): ?>
								 <tr class="price-per-night">
									<td style="padding-bottom: 15px;"><strong>Balance transaction ID:</strong></td>
									<td class="amt" style="text-align: right; padding-bottom: 15px;"><?php echo e($payment->balance_transaction); ?></td>
								</tr>
								<?php endif; ?>
								<?php if($payment->receipt_url): ?>
								 <tr class="price-per-night">
									<td style="padding-bottom: 15px;"><strong>Receipt:</strong></td>
									<td class="amt" style="text-align: right; padding-bottom: 15px;"><a href="<?php echo e($payment->receipt_url); ?>">View Receipt</a></td>
								</tr>
								<?php endif; ?>
			    </table>
			</div>
...
</html><?php /**PATH /home/rv66rental/htdocs/www.rv66rental.com/projects/resources/views/mail/booking-first-customer.blade.php ENDPATH**/ ?>