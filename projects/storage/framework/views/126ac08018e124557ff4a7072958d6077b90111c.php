                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <?php if($client->status=="active"): ?>
                                <a href="<?php echo route($route.'.deactive', [$client->id]); ?>" class="btn btn-outline-danger btn-xs raw-margin-right-8"> Deactive</a>
                              <?php else: ?>

                                <a href="<?php echo route($route.'.active', [$client->id]); ?>" class="btn btn-outline-success btn-xs raw-margin-right-8"> Active</a>
                              <?php endif; ?>
                            </td>
                            <td>
...
<script>
  ...
  $(document).on("click",".delete-checkbox",function(){
      ajaxCallCheckBoxDelete("<?php echo e(route('multipleDelete','galleries')); ?>","<?php echo e(route('galleries.index')); ?>","galleries");
  });


</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rv66rental/htdocs/www.rv66rental.com/projects/resources/views/admin/galleries/index.blade.php ENDPATH**/ ?>