  <?php
        //dd($booking_data['how_many_payment_done']);
    ...
    <?php if($property->guest_fee>0): ?>
        <?php if($property->no_of_guest): ?>
            <?php if($property->no_of_guest<$total_guests): ?>
                ...
                <?php $sub_total+=$guest_fee;$total_amount+=$guest_fee;  ?>
...
<?php endif; ?> 
  ...
  <?php $ids=[];
                ...
                <tr>
                  ...
                  <?php
                        ...
                        if(in_array($c->id,$ids)){
                            if($c->accessories_type=='per night'){
              					$abc_amount=$c->accessories_rate*$day;
              				}
              				else{
                 ...
                 <tr>
                    <th colspan="4">
                        ...
                        <?php if($c->accessories_type=='per night'): ?>
                        <input type="hidden" value="<?php echo e($value_1); ?>" name="accessories_rate_id[field][<?php echo e($c->id); ?>]" id="accessories_rate_id<?php echo e($c->id); ?>field" class="<?php echo e(in_array($c->id,$ids)?'':'d-none'); ?>  rate-calculateion-data"> 
                       <?php else: ?>
                      	<input type="text" value="<?php echo e($value_1); ?>" name="accessories_rate_id[field][<?php echo e($c->id); ?>]" id="accessories_rate_id<?php echo e($c->id); ?>field" class="<?php echo e(in_array($c->id,$ids)?'':'d-none'); ?>  rate-calculateion-data"> 
                       <?php endif; ?>
           ...
           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr >
                ...
                <td align="right"><?php echo ModelHelper::getDataFromSetting('payment_currency'); ?><?php echo e(number_format($total_amount,2)); ?></td>
					    ...
					    <?php if($main_data['coupon_discount']): ?>
                            <?php if($main_data['coupon_discount']!=""): ?>
                                <?php if($main_data['coupon_discount']!=0): ?>
                                
                                <?php
                                $coupon=App\Models\Coupon::where(["code"=>$main_data['coupon_discount_code']])->first();
                                ...
                                <tr>
                                    <td align="left" colspan="4" style="padding: 10px; " valign="top"><strong>Discount (<?php echo e($main_data['coupon_discount_code']); ?>):</strong></td>
                                    <td align="right" style="padding: 10px; " valign="top">- <?php echo $setting_data['payment_currency']; ?><?php echo e(number_format($discount,2)); ?></td>
                                </tr>
           ...
           <?php endif; ?>
            ...
            <?php
                $payments=App\Models\Payment::where(["booking_id"=>$booking_data->id,"status"=>"complete"])->get();
            ?>
            ...
            <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                   ...
                   <?php
                    $remaining_total_amount=$remaining_total_amount-$c->amount;
                   ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
elseif($payment_interval==2){
   ...
   // dd($second_days);
    if($days>=$second_days){
        //dd('if');
        if($booking_data['how_many_payment_done']==0){    
            //dd('helloif');  
            ...
            $amount_data = json_decode($booking_data['amount_data'], true); 
            ...
            foreach ($amount_data as &$item) {
                if (isset($item['type']) && $item['type'] === 'second' && !$second_updated) {
                    $item['amount'] = $remaining_total_amount;
                    $item['message'] = $second_message;
                    $second_updated = true;
                }
            }
            unset($item);
...
?>
        <?php $__currentLoopData = $amount_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <?php endif; ?>
            <tr>
                <td colspan="4"  align="left"><strong><?php echo e($c['message']); ?> <?php echo $status; ?></strong></td>
                <td align="right"><?php echo ModelHelper::getDataFromSetting('payment_currency'); ?><?php echo e(number_format($c['amount'],2)); ?></td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <input type="hidden" name="discount" value="<?php echo e($discount); ?>"  id="coupon_discount"  />
      <input type="hidden" name="discount_coupon" value="<?php echo e($main_data['coupon_discount_code']); ?>"  id="coupon_discount_code"  />
     ...
     <input type="hidden" name="tax" value="<?php echo e($tax); ?>" >
        ...
        <input type="hidden" name="define_tax" value="<?php echo e($define_tax); ?>" >
           <input type="hidden" name="booking_id" value="<?php echo e($booking_data->id); ?>" ><?php /**PATH /home/rv66rental/htdocs/www.rv66rental.com/projects/resources/views/admin/common/get-quote-edit.blade.php ENDPATH**/ ?>