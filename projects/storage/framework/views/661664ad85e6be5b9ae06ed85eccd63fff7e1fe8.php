...
<script>
  ...
  $("#data-table-gaurav").DataTable({"lengthMenu": [[ 50, -1], [ 50, "All"]], "order": [[ 1, "asc" ]],dom: "<'row'<'col-sm-3'l><'col-sm-3'f><'col-sm-6'p>>" +
   ...
   $(document).on("click",".delete-checkbox",function(){
      ajaxCallCheckBoxDelete("<?php echo e(route('multipleDelete','blog-category')); ?>","<?php echo e(route('blog-category.index')); ?>","blog-category");
  });
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rv66rental/htdocs/www.rv66rental.com/projects/resources/views/admin/blog-category/index.blade.php ENDPATH**/ ?>