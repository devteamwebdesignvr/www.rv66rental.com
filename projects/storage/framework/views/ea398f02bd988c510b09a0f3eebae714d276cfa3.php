...
<section class="banner-wrapper p-0">
    <div class="video-sec">
        <video src="<?php echo e(asset('front')); ?>/images/Renata.mp4" loop="" muted="" autoplay="" id="mob" class="mob__video" playsinline=""></video>
...
<!-- banner slider end -->
	...
	<form action="<?php echo e(url('get-quote')); ?>" method="get">
	    	<input type="hidden" name="property_id" value="<?php echo e(App\Models\Property::where(['status'=>'true'])->first()->id ?? 0); ?>">
	<?php else: ?>
	...
	<?php endif; ?>
		...
		<div class="row">
			...
			<div class="col-3 md-3 icns mb-lg-0 position-relative">
			    <!--<label>From</label>-->
				<?php echo Form::text("start_date",null,["required","autocomplete"=>"off","inputmode"=>"none","id"=>"start_date","placeholder"=>"From","class"=>"form-control"]); ?>

				<i class="fa-solid fa-calendar-days"></i>
			</div>
			<div class="col-3 md-3 icns mb-lg-0 position-relative">
			    <!--<label>To</label>-->
				<?php echo Form::text("end_date",null,["required","autocomplete"=>"off","inputmode"=>"none","id"=>"end_date","placeholder"=>"To","class"=>"form-control lst" ]); ?>
			...
			<!--<label>Type</label>-->
				<?php echo Form::select("location_id",ModelHelper::getLocationSelectList(),null,["class"=>"","placeholder"=>"Choose Vehicle Type"]); ?>
			...
			<?php if(App\Models\Property::where(["status"=>"true"])->count()==1): ?>
        		...
        		?>
                <div class="col-lg md-2 icns mb-lg-0 position-relative pets"   style="<?php echo e(ModelHelper::showPetFee($prop->pet_fee)); ?>">
                     <?php echo Form::selectRange("no_of_pets",1,$prop->max_pet,null,["class"=>"form-control","style"=>"border: 1px solid #cacaca;margin-top: 0px;","id"=>"pet_fee_data_guarav","placeholder"=>"Pets"]); ?>
...
<section class="review-sec">
  ...
  <ul>
    ...
    <li role="button" class="<?php echo e($i==0?'active':''); ?>" style="background-image: url(<?php echo e(asset($c->image)); ?>);">
      <h3><a href="<?php echo e(url('/properties/location/'.$c->seo_url)); ?>"><?php echo e($c->name); ?></a></h3>
      <div class="section-content">
        <div class="inner">
          <div class="bio">
            <h2><a href="<?php echo e(url('/properties/location/'.$c->seo_url)); ?>"><?php echo e($c->name); ?></a></h2>
...
<?php if(App\Models\Property::where(["is_home"=>"true","status"=>"true"])->count()>0): ?>
...
<div class="container">
        <div class="row row-cols-1 row-cols-md-3 g-4">
             <?php $__currentLoopData = App\Models\Property::where(["is_home"=>"true","status"=>"true"])->limit(6)->orderBy("id","desc")->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col">
              <div class="card">
               <a href="<?php echo e(url('properties/detail/'.$c->seo_url)); ?>">
                   <center> 
                        <?php if($c->feature_image): ?>
                            <img src="<?php echo e(asset($c->feature_image)); ?>" class="card-img-top" alt="<?php echo e($c->name); ?>">
                        <?php endif; ?>
                   </center>
               </a>
                <div class="card-body">
                    <h5 class="card-title"> <a href="<?php echo e(url('properties/detail/'.$c->seo_url)); ?>"><?php echo e($c->name); ?></a></h5>
                    ...
                    <div class="price-area">
                        <a href="<?php echo e(url('properties/detail/'.$c->seo_url)); ?>" class="btn-25"><span>Book Now</span></a>
                        <div class="price">
                            <p><span><?php echo $setting_data['payment_currency']; ?><?php echo e(Helper::getPriceAmountData($c->id)); ?></span> / night</p>
                        </div>
                    </div>
                </div>
              </div>
          ...
          <a href="<?php echo e(url('/properties')); ?>" class="btn-25" id="more-btn"><span>View More</span></a>
</div>
</div>
    </section>
<?php endif; ?>
...
<section class="gallery">
      <img src="<?php echo e(asset('front')); ?>/images/aucapina.jpg" alt="" class="head-img">
          ...
          <div class="gallery" id="g-cruise">
                  <div class="row cruise" >
                        <div class="col-lg-3 col-md-3 col-12 grid-sizer"></div>
                            <?php $__currentLoopData = App\Models\Gallery::orderBy("id","desc")->limit(12)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-lg-3 col-md-3 col-12 grid-item">
                                   <div class="img-wrapper">
                                        <img class="inner-img" src="<?php echo e(asset($c->image)); ?>" title="" alt="" style="transition: 0.3s;width: 100%;">
                                    </div>
                               </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              ...
              <a href="<?php echo e(url('gallery')); ?>" id="view-gall" class="btn-25"><span>View more</span></a>
          </div>
      ...
      <div class="container-fluid">
        <div class="cta-content">
          <h2>Explore the ultimate freedom of the open road with RV66 Rental. Our vision is to unlock extraordinary adventures for our guests, offering unrivaled opportunities to discover new destinations and create lifelong memories.</h2>
            ...
            <a href="<?php echo e(url('/properties')); ?>" class="rental btn-25"> <span>Book your rv rental</span></a>
        </div>
      </div>
      </div>
    </section>
    ...
    <div class="container">
        ...
        <div class="testimo-right">
            <div class="testimo-centent slick-testimonial">
                ...
                <div class="test-desc">
                    <p data-aos="fade-up" data-aos-duration="1500" class="readMore_review"><?php echo e($c->message); ?></p>
     ...
     <div class="row icon">
         <a><img src="<?php echo e(asset('front')); ?>/images/airbnb.webp" class="img-fluid" alt="airbnb"></a>
         <a><img src="<?php echo e(asset('front')); ?>/images/vrbo.webp" class="img-fluid" alt="vrbo"></a>
         <a href="http://www.flarbo.com/" target="_blank"><img src="<?php echo e(asset('front')); ?>/images/flarbo.png" class="img-fluid" alt="flarbo"></a>
        </div>
    </div>
</section>
        ...
        <div class="test-sec slick-review">
          ...
          <div class="test-cont">
            ...
            <div class="cont-sec">
              ...
              <div class="para">
                 <p class="clt-name"><strong><?php echo e($c->name); ?></strong></p>
                <p><i class="fa-solid fa-quote-left"></i> <span> <?php echo e($c->message); ?></span> <i class="fa-solid fa-quote-right"></i></p>
              </div>
            </div>
          </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rv66rental/htdocs/www.rv66rental.com/projects/resources/views/front/static/home.blade.php ENDPATH**/ ?>