           ...
           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr  id="coupon-form" style="display:none;">
                <td colspan="3"  align="left">
                    ...
                    <?php else: ?>
                        <input type="text" name="coupon" style="" value="<?php echo e(Request::get('coupon')); ?>"  placeholder="Enter Coupon Code" />
                    <?php endif; ?>
...
<script>
    ...
    $(document).on("change",".accessories-rate-per_night",function(){
        var target=$(this).data("target");
        $("#"+target).val("<?php echo e($main_data['total_night']); ?>");
        ajaFunction();
    });
...
function ajaFunction(){
    <?php if(Request::get("coupon")): ?>
    url="<?php echo e(url('get-quote-post')); ?>?coupon=<?php echo e(Request::get('coupon')); ?>";
    <?php else: ?>
    url="<?php echo e(url('get-quote-post')); ?>";
    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.layouts.master", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/rv66rental/htdocs/www.rv66rental.com/projects/resources/views/front/static/get-quote.blade.php ENDPATH**/ ?>