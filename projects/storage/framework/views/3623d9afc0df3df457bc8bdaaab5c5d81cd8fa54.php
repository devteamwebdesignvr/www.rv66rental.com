	        ...
	        <table class="pro-sec" style="padding: 10px 0; padding-bottom: 20px; border-spacing: 0px; width:100%;">
	            <tr>
	                ...
	                <td class="pro-detail" style="width: 90%; vertical-align: top;">
	                    ...
	                    <p class="pro-value" style="font-size: 13px;">
	                        <?php if($property->sleeps): ?>
	                            <?php echo e($property->sleeps); ?> Sleeps
	                        <?php endif; ?>
	                        <?php if($property->bedroom): ?>
	                            路  <?php echo e($property->bedroom); ?> bedrooms
	                        <?php endif; ?>
	                        <?php if($property->bathroom): ?>
	                            路 <?php echo e($property->bathroom); ?> bathrooms
	                        <?php endif; ?>
...
</html><?php /**PATH /home/rv66rental/htdocs/www.rv66rental.com/projects/resources/views/mail/booking-user-email.blade.php ENDPATH**/ ?>