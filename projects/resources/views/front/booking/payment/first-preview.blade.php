                            ...
                            <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tbody>
								    ...
								    @if($booking['rest_guests']>0)
								        @if($booking['guest_fee'])
								            ...
								            <tr>
            									<td align="left" colspan="3" style="padding: 10px; font-weight: bold; font-size: 15px; color:#000; border: 1px solid #02c3ff; border-right:0px solid #02c3ff; border-bottom:0px solid #02c3ff;" valign="top"><strong> Additional Guest Fee <br> <span style="font-size:13px;">({{$booking['total_night']}} nights * {!! $setting_data['payment_currency'] !!}{{$booking['single_guest_fee']}} * {{$booking['rest_guests']}} Guests)</span></strong></td>
                                    ...
                                    @if($booking['custom_before_total_fees'])
                                        @foreach(json_decode($booking['custom_before_total_fees'],true) as $p)
                                            @isset($p['product_amount'])
                                                <tr>
                                                    <td align="left" colspan="3" style="padding: 10px;" valign="top"><strong>{{$p['product_name']}} :</strong></td>
							    ...
							    @if($booking['discount'])
                                    @if($booking['discount']!="")
                                        ...
                                        <tr>
                                            <td align="left" colspan="3" style="padding: 10px; font-weight: bold; font-size: 15px; color:#000; border: 1px solid #02c3ff; border-right:0px solid #02c3ff border-bottom:0px solid #02c3ff;;" valign="top"><strong>Discount ({{ $booking['discount_coupon'] }}):</strong></td>
