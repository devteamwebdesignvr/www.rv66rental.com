...
@section('title', 'Admin')
@php 
    $name="Properties Group Amenities";$route="properties-group-amenities";
@endphp            
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
          @php 
            $addbar=["name"=>$name,"add-data"=>false,"add-name"=>"Add ". Str::singular($name),"add-anchor"=>route($route.'.create',[$property_id]),"back-anchor"=>route("properties.edit",[$property_id])];
          @endphp
