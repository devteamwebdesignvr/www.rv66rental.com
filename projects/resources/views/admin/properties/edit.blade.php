...
<script>
    ...
    $(document).on("click",".add-fee-data",function(){
        html=`
            <div class="row gaurav-delete-property">
                ...
                <div class="col-md-2">
                    {!! Form::select("fee_apply[]",["total"=>"Total Amount","gross"=>"Gross Total"],null,["required","class"=>"form-control"]) !!}
                </div>
                <div class="col-md-2">
    ...
    $(document).on("click",".add-accessories-data",function(){
        html=`
            <div class="row gaurav-delete-accessories">
                <div class="col-md-2">
                    {!! Form::text("accessories_name[]",null,["required","class"=>"form-control","placeholder"=>" Name"]) !!}
                </div>
                <div class="col-md-2">
                    {!! Form::text("accessories_helping_text[]",null,["required","class"=>"form-control","placeholder"=>" Helping Text"]) !!}
                </div>
                <div class="col-md-2">
                    {!! Form::text("accessories_rate[]",null,["required","class"=>"form-control","placeholder"=>" Rate"]) !!}
                </div>
                
                <div class="col-md-2">
                    {!! Form::select("accessories_type[]",["per night"=>"Per Night","per person"=>"Per Person","per stay"=>"Per Stay"],null,["required","class"=>"form-control"]) !!}
                </div>
                <div class="col-md-2">
                    {!! Form::select("accessories_status[]",["active"=>"active","deactive"=>"deactive"],null,["required","class"=>"form-control"]) !!}
                </div>
                <div class="col-md-2">
    ...
    $(document).on("click",".add-milleage-data",function(){
        html=`
            ...
            <div class="col-md-3">
                    {!! Form::text("milleage_name[]",null,["required","class"=>"form-control","placeholder"=>" Name"]) !!}
                </div>
                <div class="col-md-1">
                    {!! Form::text("milleage_rate[]",null,["required","class"=>"form-control","placeholder"=>" Rate"]) !!}
                </div>
                <div class="col-md-1">
                    {!! Form::text("milleage_free[]",null,["class"=>"form-control","placeholder"=>" Free"]) !!}
                </div>
                <div class="col-md-4">
					{!! Form::select("milleage_format[]",["millage"=>"Millage","generator_hour"=>"Generator Hours"],null,["required","class"=>"form-control"]) !!}
                </div>
                
                <div class="col-md-2">
                    {!! Form::select("milleage_status[]",["active"=>"active","deactive"=>"deactive"],null,["required","class"=>"form-control"]) !!}
                </div>
                <div class="col-md-1">
    ...
    $(document).on("click",".add-option-data",function(){
        ...
        html=`
            ...
            <div class="row gaurav-delete-option">
                <div class="col-md-4">
                    {!! Form::text("option_name[]",null,["required","class"=>"form-control","placeholder"=>" Name"]) !!}
                </div>
                <div class="col-md-4">
                    {!! Form::text("option_rate[]",null,["required","class"=>"form-control","placeholder"=>" Rate"]) !!}
                </div>
                
                <div class="col-md-2">
                    {!! Form::select("option_status[]",["active"=>"active","deactive"=>"deactive"],null,["required","class"=>"form-control"]) !!}
                </div>
                <div class="col-md-2">
